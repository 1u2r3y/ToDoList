    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent,ADD_NOTE_REQUEST); //start second Activity
            }
        });
        ...
        //позволяем системе предоставить нам правильный экземпляр ViewModel
        //передаем Activity или Fragment, для которого должен быть ограничен жизненный цикл этого ViewModel
